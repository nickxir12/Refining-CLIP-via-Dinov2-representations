...
_VITB32 = dict(
    ...
    commonpool_m_clip_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M.clip-s128M-b4K/"
    ),
    commonpool_m_laion_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M.laion-s128M-b4K/"
    ),
    commonpool_m_image_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M.image-s128M-b4K/"
    ),
    commonpool_m_text_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M.text-s128M-b4K/"
    ),
    commonpool_m_basic_s128m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.M.basic-s128M-b4K/"
    ),
    ...
    commonpool_s_clip_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S.clip-s13M-b4K/"
    ),
    commonpool_s_laion_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S.laion-s13M-b4K/"
    ),
    commonpool_s_image_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S.image-s13M-b4K/"
    ),
    commonpool_s_text_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S.text-s13M-b4K/"
    ),
    commonpool_s_basic_s13m_b4k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-32-CommonPool.S.basic-s13M-b4K/"
    ),
...
_VITB16 = dict(
    ...
    commonpool_l_clip_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L.clip-s1B-b8K/"
    ),
    commonpool_l_laion_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L.laion-s1B-b8K/"
    ),
    commonpool_l_image_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L.image-s1B-b8K/"
    ),
    commonpool_l_text_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L.text-s1B-b8K/"
    ),
    commonpool_l_basic_s1b_b8k=_pcfg(
        hf_hub="laion/CLIP-ViT-B-16-CommonPool.L.basic-s1B-b8K/"
    ),
...
_convnext_base_w = dict(
    ...
    laion2b_s13b_b82k_augreg=_pcfg(
        hf_hub="laion/CLIP-convnext_base_w-laion2B-s13B-b82K-augreg/"
    ),
    laion_aesthetic_s13b_b82k=_pcfg(
        hf_hub="laion/CLIP-convnext_base_w-laion_aesthetic-s13B-b82K/"
    ),
)
...
_convnext_large_d_320 = dict(
    laion2b_s29b_b131k_ft=_pcfg(
        hf_hub="laion/CLIP-convnext_large_d_320.laion2B-s29B-b131K-ft/"
    ),
...
_convnext_xxlarge = dict(
    laion2b_s34b_b82k_augreg=_pcfg(
        hf_hub="laion/CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg/"
    ),
...
_PRETRAINED = {
    ...
    "ViT-SO400M-14-SigLIP-378": dict(
        webli=_slpcfg(
            hf_hub="timm/ViT-SO400M-14-SigLIP-384/"
        ),  # NOTE using 384 weights, but diff img_size used
    ),
    ...
    "MobileCLIP-S1": dict(datacompdr=_mccfg(hf_hub="apple/MobileCLIP-S1-OpenCLIP/")),
    "MobileCLIP-S2": dict(datacompdr=_mccfg(hf_hub="apple/MobileCLIP-S2-OpenCLIP/")),
    "MobileCLIP-B": dict(
...
def _get_safe_alternatives(filename: str) -> Iterable[str]:
    ...
    if filename not in (HF_WEIGHTS_NAME,) and (
        filename.endswith(".bin") or filename.endswith(".pth")
    ):
